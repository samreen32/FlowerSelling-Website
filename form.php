...
global $city;
 ...
 require_once('database.php');      //using other files code. 
 if(isset($_POST) & !empty($_POST)){
	 ...
	 $res = $database->create($name, $email, $address, $city);
	 if($res){
 ...
 <section class="about section container">
    <div class="home__data">
        ...
        <div> 
            ...
            <input class="home__description" type="text" name="name"><br>
            <label style="width:100px; display:inline-block;">E-mail: </label>&nbsp;
            <input class="home__description" type="text" name="email"><br>
            <label style="width:100px; display:inline-block;">Address: </label>&nbsp;
            <input class="home__description" type="text" name="address"> <br>
            <label style="width:100px; display:inline-block;">City: </label>&nbsp;
            <input class="home__description" type="text" name="city"><br>
        </div>
